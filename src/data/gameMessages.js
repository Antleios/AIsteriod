...
const messageBuilders = {
  objectNaming: {
    ...
    incorrect: [
      ...
      () => ({
        display: '已经很接近了，再想一想它叫什么吧。💡',
        speech: '已经很接近了，再想一想它叫什么吧。',
      }),
      () => ({
  ...
  emojiMatch: {
    ...
    correct: [
      ({ emoji, target }) => ({
        display: `答对了！${emoji} 就是${target}！太棒了！🎉`,
        speech: `答对了！这就是${target}！太棒了！`,
      }),
      ({ emoji, target }) => ({
